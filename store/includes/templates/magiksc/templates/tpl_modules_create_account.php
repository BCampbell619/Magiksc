...
<div class="row no-gutters">
    ...
    </div><!-- END OF COMPANY COL WRAPPER -->
</div><!-- END OF COMPANY ROW -->
<?php
  }
?>
...
</div><!-- END OF ADDRESS DETAILS ROW -->
</fieldset>
...
?>
</div><!-- END OF ADDITIONAL CONTACT DETAILS ROW -->
</fieldset>
...
<div class="row">
    ...
    <div class="d-none d-md-block d-lg-block col-md-6"></div>
<?php
  if ($phpBB->phpBB['installed'] == true) {
?>
    <div class="col-xs-12 col-sm-12 col-md-6 d-block">
...
</div><!-- END OF NEW LOGIN CREDS ROW -->
</fieldset>
...
?>
    <div class="col-1 d-inline">
        <?php echo zen_draw_checkbox_field('newsletter', '1', $newsletter, 'id="newsletter-checkbox"') . '</div> <div class="col-4 d-inline"> <label class="checkboxLabel" for="newsletter-checkbox">' . ENTRY_NEWSLETTER . '</label>' . (zen_not_null(ENTRY_NEWSLETTER_TEXT) ? '<span class="alert">' . ENTRY_NEWSLETTER_TEXT . '</span>': ''); ?>
    </div>
<?php } ?>
    <div class="col-1 d-inline">
<?php echo zen_draw_radio_field('email_format', 'HTML', ($email_format == 'HTML' ? true : false),'id="email-format-html"') . '</div> <div class="col-2 d-inline"> <label class="radioButtonLabel" for="email-format-html">' . ENTRY_EMAIL_HTML_DISPLAY . '</label> </div> <div class="col-1 d-inline">' .  zen_draw_radio_field('email_format', 'TEXT', ($email_format == 'TEXT' ? true : false), 'id="email-format-text"') . '</div> <div class="col-2 d-inline"> <label class="radioButtonLabel" for="email-format-text">' . ENTRY_EMAIL_TEXT_DISPLAY . '</label>'; ?>
    </div>
</div><!-- END OF NEWSLETTER EMAIL PREFERENCE ROW -->
</fieldset>
