 ...
 */
?>
<div class="row" id="passwordForgotten">
    <div class="col-12">
...
<div class="row">
    <div class="col-12"><?php echo FORM_REQUIRED_INFORMATION; ?></div>
...
<?php echo zen_draw_input_field('email_address', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' id="email-address"') . '&nbsp;' . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="alert">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?>
    </div><!-- END OF COL-6 WRAPPER FOR ADDRESS INPUT -->
</div><!-- END OF INNER FORM ROW -->
</fieldset>
<div class="row">
    <div class="col-12 clearfix">
        <div class="float-left"><?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div> 
        <div class="float-right"><?php echo zen_back_link() . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></div>
    </div><!-- CLEAR FIX -->
</div><!-- END OF BUTTON ROW FOR PASSWORD RESET -->
</form>
    </div><!-- END OF FORGOT PASSWORD FORM COL-12 WRAPPER -->
</div><!-- END OF FORGOT PASSWORD ROW -->