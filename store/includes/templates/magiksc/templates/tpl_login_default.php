...
<div class="row no-gutters" id="loginDefault">
...
?>
    ...
    <div class="col-12">
        <p class="advisory"><?php echo TEXT_VISITORS_CART; ?></p>
    </div>
<?php
  }
?>
...
</div><!-- END OF ROW FOR LOGIN BUTTONS -->
</form>
        </div><!-- END OF FORM COL WRAPPER -->
    </div><!-- END OF ROW FOR LOGIN FORM -->
</div><!-- END OF LOGIN FORM COL-12 WRAPPER -->
...
</div><!-- END OF CREATE ACCOUNT COL-12 WRAPPER -->
<!--EOF normal login-->
<?php } ?>
