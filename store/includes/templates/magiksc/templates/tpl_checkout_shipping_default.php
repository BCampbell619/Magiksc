 ...
 */
?>
<div class="row" id="checkoutShipping">
    <div class="col-12">
...
?>
</div><!-- END OF SHIPPING OPTIONS ROW -->
</fieldset>
</div>
<?php
    }
...
</div><!-- END OF SHIPPING SELECTION ROW -->    
<?php    }
?>
...
<div class="row">
    ...
    </div><!-- END OF SHIPPING DEFAULT FORM COL-12 WRAPPER -->
</div> <!-- END OF SHIPPING DEFAULT ROW -->