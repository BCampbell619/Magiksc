 ...
 */
?>
<div class="row" id="accountEditDefault">
    <div class="col-12">
...
<div class="row">
<div class="col-12 alert forward">
...
<div class="row">
    ...
    <div class="col-6">
<?php echo zen_draw_radio_field('email_format', 'HTML', $email_pref_html,'id="email-format-html"') . ENTRY_EMAIL_HTML_DISPLAY . '</div> <div class="col-6">' . zen_draw_radio_field('email_format', 'TEXT', $email_pref_text, 'id="email-format-text"') . ENTRY_EMAIL_TEXT_DISPLAY . '</div>'; ?>
</div><!-- END OF EMAIL PREFS FIELDSET ROW -->
</fieldset>
...
<br class="clearBoth" />
    ...
    </div><!-- END OF COL-12 FORM WRAPPER -->
</div><!-- END OF ACCOUNT EDIT ROW -->