 ...
 */
?>
<div class="row mt-2 mb-4" id="checkoutShipAddressDefault">
    <div class="col-12">
...
<div class="row">
    <div class="col-12 clearfix">
        ...
        <div class="float-left ml-2"><?php echo TITLE_CONTINUE_CHECKOUT_PROCEDURE . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></div>

<?php
  if ($process == true) {
?>
  <div class="float-right"><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></div>
...
?>
    ...
    </div><!-- END OF CHECKOUT SHIPPING ADDRESS DEFAULT COL WRAPPER -->
</div><!-- END OF CHECKOUT SHIPPING ADDRESS DEFAULT ROW -->