...
<div class="row" id="accountDefault">
...
<?php
  ...
  ?>
    ...
    <div class="col-12 table-responsive">
        <table class="table" id="prevOrders">
...
?>
    ...
    </div><!-- END OF COL-12 WRAPPER FOR TABLE -->
<?php
  }
?>

    <div id="accountLinksWrapper" class="col-12 mt-2 mb-4">
        <h2><?php echo MY_ACCOUNT_TITLE; ?></h2>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4">
                <ul id="myAccountGen" class="list-group">
...
?>
    <div class="col-12 mt-2 mb-4">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4">
                <ul id="myAccountNotify" class="list-group">
<?php
...
<?php } //endif product notification ?>
        ...
        </div><!-- END OF EMAIL NOTIFY ROW -->
    </div>
<?php } // endif don't show unsubscribe or notification ?>
</div><!-- END OF ACCOUNT INFO ROW -->
