...
?>
<!--// bof: <?php echo $box_id; ?> //-->
<div class="" id="<?php echo str_replace('_', '-', $box_id ); ?>">
<?php //<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="<?php echo str_replace('_', '-', $box_id ); ?> <?php //" style="width: <?php echo $column_width; ?><?php //" ?>
