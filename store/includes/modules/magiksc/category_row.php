...
/* 
MAX_DISPLAY_CATEGORIES_PER_ROW is a database configuration value which is set to 3
This sets the width of the columns for the sub categories
*/
  ...
  while (!$categories->EOF) {
    if (!$categories->fields['categories_image']) !$categories->fields['categories_image'] = 'pixel_trans.gif';
      ...
      $id = str_replace(" ", "_", $categories->fields['categories_name']);
      $id = str_replace(",", "_", $id);
      $id = str_replace("/", "_", $id);
