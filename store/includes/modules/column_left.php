...
while (!$column_left_display->EOF and $box_cnt < 100) {
  ...
  //includes/modules/sideboxes/[sideboxfile_name.php] OR includes//modules/sideboxes/[CUSTOM TEMPLATE]/[sideboxfile_name.php]
?>
<?php
//$column_box_spacer = 'column_box_spacer_left';
$column_width = BOX_WIDTH_LEFT; //This is in the database table configuration
//This checks to see if there is a file in a special template directory, else it moves to the regular modules file
